...
* add ai-based project type detection and workflow support ([f753f8b](https://github.com/cloudflare/vibesdk/commit/f753f8bc1dc587de106dc1b413c11fc796cbd7cb))
...
* add clarifying questions flow for Think agent ([a52cf10](https://github.com/cloudflare/vibesdk/commit/a52cf10740c3c9c7a3914dcaedee97018b48ddc2))
...
* add completion detection and dependency-aware tool execution ([0f85a7d](https://github.com/cloudflare/vibesdk/commit/0f85a7d00934cbc3ec4beb706689cbda93478fb8))
* add completion detection and loop prevention to agentic builder and debugger ([e926e18](https://github.com/cloudflare/vibesdk/commit/e926e18b1bbce27f53df7758d46929426e056e07))
...
* add presentation and documentation preview modes ([#234](https://github.com/cloudflare/vibesdk/issues/234)) ([e9a31da](https://github.com/cloudflare/vibesdk/commit/e9a31da370bcf82769ccb85b2286437e63dfc695))
* add project mode selector with agentic behavior support ([b34c707](https://github.com/cloudflare/vibesdk/commit/b34c7079153ee0455a2d2b650a4256365a11e9d7))
...
* add read-only Artifacts HTTP router ([cfcfb70](https://github.com/cloudflare/vibesdk/commit/cfcfb7030b2dfc9c3704796f2a3710fa700135f7))
* add read-only Artifacts repo viewer for think apps ([4b75d88](https://github.com/cloudflare/vibesdk/commit/4b75d883eab2527242f4420a3585ad99f366176f))
...
* add the client and React surfaces ([0e1f72f](https://github.com/cloudflare/vibesdk/commit/0e1f72fa77ad6da57871ba70c132ef1252a4ec1d))
* agentic streaming presentations finally working ([00fc51c](https://github.com/cloudflare/vibesdk/commit/00fc51cfb6e729409f530f1b14b1b601b18fdaab))
* bring app actions to chat page as well from app page ([f33e163](https://github.com/cloudflare/vibesdk/commit/f33e1636a5cc1f970a9a6d425942a1cbd3281916))
* bug fixes + save manifest and slides proactively upon generation ([ff47fc8](https://github.com/cloudflare/vibesdk/commit/ff47fc8b2f4df9921eb0f278bb7942d15849746a))
...
* **chat:** ordered reasoning + tool trace across all agent behaviors ([942b581](https://github.com/cloudflare/vibesdk/commit/942b581693e3c880c78526f56f72e820d1196bc4))
* **chat:** revamp tool calls ui ([2201ebe](https://github.com/cloudflare/vibesdk/commit/2201ebe639f268c890aa04d59bc6439b4517326b))
* **chat:** revamp tool calls ui ([21c55d7](https://github.com/cloudflare/vibesdk/commit/21c55d7e9c5e1fbf731cc69a1974b059664cd5e5))
...
* **deploy:** backend-error-driven CF connect popup ([8422857](https://github.com/cloudflare/vibesdk/commit/842285751b5adc16c343cd04c95f52532d5c1135))
* **deploy:** backend-error-driven CF connect popup and ENABLE_USER_ACCOUNT_DEPLOY platform deploys ([dda43bd](https://github.com/cloudflare/vibesdk/commit/dda43bde49fddbb7c24ebc0653a0a2bbfb6a5110))
...
* **example:** add a Cloudflare Workers demo with five themes ([a9c4c9e](https://github.com/cloudflare/vibesdk/commit/a9c4c9e42d123f2fb3672abd1fac103a3e95d24c))
* **example:** demonstrate renderStatus across the themed designs ([5aa205d](https://github.com/cloudflare/vibesdk/commit/5aa205d0b4909732f37a0321f6cd5c8c481a3b60))
* **example:** route artifacts through Hono at /api/artifacts ([88b73cb](https://github.com/cloudflare/vibesdk/commit/88b73cbadfef85c1a536176913120af3a038746f))
...
* finish most refactor and get it to build ([d2a7e02](https://github.com/cloudflare/vibesdk/commit/d2a7e02105d779b9f6278ea564caa65406225945))
* gemini 3 flash ([6452622](https://github.com/cloudflare/vibesdk/commit/64526224e96e8284e345bdcc61cdf28d0c49658a))
* general agent ([45eb5c0](https://github.com/cloudflare/vibesdk/commit/45eb5c087d3b42651027516edd8c4be34958fc13))
...
* improve GitHub Actions workflow reliability ([1e49bb3](https://github.com/cloudflare/vibesdk/commit/1e49bb365c83b9e2fdebf76d36b9401479121cdc))
...
* introduce @cloudflare/kumo, theme toggle and ui fixes ([942832c](https://github.com/cloudflare/vibesdk/commit/942832cef0e2c1571b3719a2c280e73da253644a))
* introduce @tanstack/query and use it in sidebar apps list fetches ([16142fc](https://github.com/cloudflare/vibesdk/commit/16142fc5ad0df94f5cccbf4f5c1dc9a5b85ab0d9))
* introduce kumo, other ui fixes ([35114e8](https://github.com/cloudflare/vibesdk/commit/35114e825615e60bd576f64f5e80d9622db5868b))
...
* manage feature toggles outside Wrangler vars ([0bfd169](https://github.com/cloudflare/vibesdk/commit/0bfd16911c120e7ea3f9c5eca39adea81d89a323))
* more ui updates, fixes ([74b28cd](https://github.com/cloudflare/vibesdk/commit/74b28cd7adec7521b7f13a60626c581400a3af8e))
...
* persist tanstack query in IndexedDB ([dae555d](https://github.com/cloudflare/vibesdk/commit/dae555de1d26259a5f4612574fe05cd92e83e598))
* persist tanstack query in IndexedDB ([a904751](https://github.com/cloudflare/vibesdk/commit/a9047515abbda0c4ad046f1566789e3d11bed6d8))
...
* presentation specific prompts + prompts restructuring ([b6abaca](https://github.com/cloudflare/vibesdk/commit/b6abaca2cffca283c4e0974905c3a1165542400f))
...
* **react:** let consumers replace loading, empty, and error markup ([7dec701](https://github.com/cloudflare/vibesdk/commit/7dec70119c8e23d41b2ae08d383a5be689c59f07))
...
* refactor file manager to separate state recording from git operations ([e3d0862](https://github.com/cloudflare/vibesdk/commit/e3d0862d5daf8cb2a1d1ae3e9e9bff4ee2989abf))
...
* remove redundant message and fix file saving in code generation ([6f170e1](https://github.com/cloudflare/vibesdk/commit/6f170e1650f60eb1139272352e0ebe34fa31845d))
...
* replace template manager with ai template selector ([ca8e7e4](https://github.com/cloudflare/vibesdk/commit/ca8e7e41b7bff0ad64f129138c8c446145597416))
* rewrite presentation preview system ([09653ba](https://github.com/cloudflare/vibesdk/commit/09653ba4e1e5a9a355e88c0c467dceb37fe9f7e8))
...
* route owned apps to editor and prefer Think live preview ([6678715](https://github.com/cloudflare/vibesdk/commit/6678715b43d13c6bdd730a1e0f8a8aea5a907538))
* route owned apps to editor and prefer Think live preview ([1a6ad37](https://github.com/cloudflare/vibesdk/commit/1a6ad37e74bb86a7a23d46698d9010df0c3db9ac))
...
* set up LinkProvider and use it in homepage view all btn ([1c65db8](https://github.com/cloudflare/vibesdk/commit/1c65db8ad0f67f2515de04e7b7d0eff2143478c9))
...
* some prompt improvements in agentic project builder ([7faf0e0](https://github.com/cloudflare/vibesdk/commit/7faf0e03cb1f8b7632d8a2f5ec92afc1cbc62d78))
* **space:** back SpaceDO filesystem with Cloudflare Artifacts ([419d37d](https://github.com/cloudflare/vibesdk/commit/419d37d97d5a4c6b0f9069e17aca7527ef7abbe6))
* **space:** gate Cloudflare Artifacts behind a per-app filesystem backend ([e341e04](https://github.com/cloudflare/vibesdk/commit/e341e04deee1f3daabbcacecb9e4e1b95d460d9d))
* **space:** require ARTIFACTS binding and fix think editor file sync ([645bb5b](https://github.com/cloudflare/vibesdk/commit/645bb5bdfdb72f900dc80344235d6a4a9f420198))
...
* **think:** isolate model and trim context ([37b1cd7](https://github.com/cloudflare/vibesdk/commit/37b1cd72f86a6b83d0116de88e382ac1a27c3c05))
* **think:** isolate model and trim context ([1abd92a](https://github.com/cloudflare/vibesdk/commit/1abd92ad919e9d3ed7127f734df2e9a6e12cae64))
...
* **ui:** redesign profile page and add orange gradient button ([ef4d30a](https://github.com/cloudflare/vibesdk/commit/ef4d30a50952e76adaa3287b9218cc74307171bb))
* **ui:** refresh app shell with Kumo ([741178d](https://github.com/cloudflare/vibesdk/commit/741178dabffb49d621508c26994f13c3ef039825))
* **ui:** refresh app shell with Kumo ([7431cf7](https://github.com/cloudflare/vibesdk/commit/7431cf774b5bf0daea4b425f713da3322f6c6d91))
...
* use agentic builder directly for handling user messages ([681bbbe](https://github.com/cloudflare/vibesdk/commit/681bbbeb7ace71a8cdebb7fc62ed35b99370cb61))
...
* add cloudflare beacon url to csp ([90561ad](https://github.com/cloudflare/vibesdk/commit/90561ad4df525a54d478a3761bd8bbb8ea2c12c1))
...
* add noopener,noreferrer to _blank targets to prevent reverse tab… ([16d7119](https://github.com/cloudflare/vibesdk/commit/16d7119d124f787aede8b50a7d5d147523a4d5d6))
* add noopener,noreferrer to _blank targets to prevent reverse tabnabbing ([70441b8](https://github.com/cloudflare/vibesdk/commit/70441b8b2f64ecc75e9a437d52fef045736bb11a))
* add optional chaining to prevent runtime errors in blueprint rendering ([2a2d86c](https://github.com/cloudflare/vibesdk/commit/2a2d86c6d2afe45b4445e70d617e39d3367fd90d))
...
* alias vendored artifacts-viewer for the Worker deploy build ([2509dfa](https://github.com/cloudflare/vibesdk/commit/2509dfad0d943efa67847b348e59fc384fa423d1))
...
* allow labeling fork pull requests ([1a83c48](https://github.com/cloudflare/vibesdk/commit/1a83c480474f3fde30518357c15ff41f66b33051))
* app and chat layouts ([c0c39af](https://github.com/cloudflare/vibesdk/commit/c0c39af2c2a73facec3771b635aa3c057bacc0f3))
...
* ask_questions tool call wording ([ce86f8d](https://github.com/cloudflare/vibesdk/commit/ce86f8dbd28e03c4a375bfb9a45e1ce4d6fdaff6))
...
* bring back some radix deps ([57472fb](https://github.com/cloudflare/vibesdk/commit/57472fbab47bc6f656d6b2065869e023208a4055))
...
* **chat:** full-width tool trace + slide-style clarifying questions ([3016918](https://github.com/cloudflare/vibesdk/commit/30169188717e6823e92cacc10f353015c2fde52f))
...
* cleanup chat.tsx for build ([d80c416](https://github.com/cloudflare/vibesdk/commit/d80c41625684f501e59d600593572c3832251638))
* cleanup chat.tsx for build ([670c8d6](https://github.com/cloudflare/vibesdk/commit/670c8d6c241d38335676440ecaa6225795ba6f2a))
* cleanup settings up and ui refresh ([612c8be](https://github.com/cloudflare/vibesdk/commit/612c8be678737df983d2773fc6c6d185a1863ae9))
* clear local state when signing out ([7d21236](https://github.com/cloudflare/vibesdk/commit/7d212364afd93c831249f66c2e900903b59fbe25))
* compact prompt box spacing and remove blueprint placeholder ([1ee7285](https://github.com/cloudflare/vibesdk/commit/1ee72851aa8beee236e12d652189e9dd002a76f2))
* convo id uniqueness and improve message deduplication ([d4ae61d](https://github.com/cloudflare/vibesdk/commit/d4ae61d6357d1c107b2ed5148ea5cbb18bfd6248))
...
* create new orange gradient button and use it ([af0b220](https://github.com/cloudflare/vibesdk/commit/af0b2203674da12f7328a2168e1e370dd0ad3f35))
* create query client in app level, not at module scope ([7f9410f](https://github.com/cloudflare/vibesdk/commit/7f9410f4aac9fa1540b08aa7cac2821cd6a6f47f))
...
* design tokens cleanup and design updates ([9de4b25](https://github.com/cloudflare/vibesdk/commit/9de4b256a32ef399a4172d3a519990faf85e5c12))
...
* discover page input components use kumo ([f3f90b6](https://github.com/cloudflare/vibesdk/commit/f3f90b6a8d952896ae7f56236074f8e4fae047e9))
...
* do not log the entire conversation history ([102cbfa](https://github.com/cloudflare/vibesdk/commit/102cbfa7a7f47501677bfa8efe843b6fb4bc5378))
* do not log the entire conversation history ([4785fa7](https://github.com/cloudflare/vibesdk/commit/4785fa7ee9a62fb46d353bfa8a3c120efbff5f1c))
...
* ensure workspace directory exists before writing files ([17258f3](https://github.com/cloudflare/vibesdk/commit/17258f3094e405360e1461dd04d8ae5b1af4cebd))
* exclude auth/account queries from persisted query cache ([ed011f2](https://github.com/cloudflare/vibesdk/commit/ed011f22d5b3e5bd689ec8637c59c964a0779ce6))
* expose artifacts setting as a worker variable ([a651a52](https://github.com/cloudflare/vibesdk/commit/a651a5277e07c40eb78b000e48f69345426b9849))
* expose artifacts setting as a worker variable ([1f2c099](https://github.com/cloudflare/vibesdk/commit/1f2c099b56805cc56270aa82e2833dedc4bfc0ed))
* files format ([da31e76](https://github.com/cloudflare/vibesdk/commit/da31e761e6cba4e839f5f0c527410128f5b18fd7))
* filter protected files ([ff3a302](https://github.com/cloudflare/vibesdk/commit/ff3a302bf8fa3059156c4f10efc30c55aa6f0455))
* fix general agent app creation ([fa080ec](https://github.com/cloudflare/vibesdk/commit/fa080ec378a6756584596da800b0944fd83b9099))
...
* gate artifacts binding on ENABLE_ARTIFACTS during deploy ([98e619d](https://github.com/cloudflare/vibesdk/commit/98e619d396df978d8003e63d90804205eb8ebd57))
* gate artifacts binding on ENABLE_ARTIFACTS during deploy ([8191265](https://github.com/cloudflare/vibesdk/commit/8191265071bebd0c55fa9182e0b4cdf16e5dea1c))
* general design updates in homepage, auth-button ([15fd104](https://github.com/cloudflare/vibesdk/commit/15fd1045c87847ae32ac947e51df023dea016f4f))
* harden AI Gateway proxy against unbounded requests (CWE-770) ([f8077b3](https://github.com/cloudflare/vibesdk/commit/f8077b368ce2326a983f3a9fcb285bbfd4f256f5))
* harden AI Gateway proxy against unbounded requests (CWE-770) ([12b7059](https://github.com/cloudflare/vibesdk/commit/12b705909eca88570dc58dc75f7dfacc2e1b8fac))
* homepage, settings page design updates and fixes ([8fd50b6](https://github.com/cloudflare/vibesdk/commit/8fd50b6a64cb9f0efe7e7d5e28ff34416091f599))
* ignore useEffect deps lint error ([72a8a86](https://github.com/cloudflare/vibesdk/commit/72a8a864b49f86bae604a6333a7b5e543689fefd))
...
* improve cross-method sign-in for shared emails ([ec29a67](https://github.com/cloudflare/vibesdk/commit/ec29a6738ea750eb3ec893f35196c921a2fe2140))
* improve font loading ([7d82ca0](https://github.com/cloudflare/vibesdk/commit/7d82ca0b7091ff42283de2cc996ff6cc5c160950))
...
* improve ui, search behavior ([46f1b2d](https://github.com/cloudflare/vibesdk/commit/46f1b2d0cab646055c413a95cba37cccf75f38f2))
...
* increase max-width for chat box when main area not visible ([0e14a7a](https://github.com/cloudflare/vibesdk/commit/0e14a7ab8db6d91298e7b3611ec4e3340f9b3027))
* increase z-index on hero text on homepage ([7c0a922](https://github.com/cloudflare/vibesdk/commit/7c0a92215d7cddedd8741f7d4c5a2cb4e01c1087))
...
* **layout:** use global header with sidebar toggle and sign-in button ([3bfa0fd](https://github.com/cloudflare/vibesdk/commit/3bfa0fd71034ac3f6cc5fb53e77ef6418912eb7b))
* make email allowlist test self-contained ([f5fdec4](https://github.com/cloudflare/vibesdk/commit/f5fdec4fcc2b0ba8cccb740e6af4e279d6af6700))
* make globe also gradient filled ([538565a](https://github.com/cloudflare/vibesdk/commit/538565a4b614fa1d5b75cb6393d60a24d7ff0d6d))
* make remote database migrations required during deploy ([a318f08](https://github.com/cloudflare/vibesdk/commit/a318f08625dbb443af7f70dd08d295fd49a0b96b))
* make remote database migrations required during deploy ([af33ab2](https://github.com/cloudflare/vibesdk/commit/af33ab217c0983ca04cd6210875f6eef338a707d))
* manual template selection ([e440372](https://github.com/cloudflare/vibesdk/commit/e440372760d69e6f587bfcb94d93c7bece39a6b6))
* max-width on title, move buttons around ([5ed143d](https://github.com/cloudflare/vibesdk/commit/5ed143da53e1ce7efdb594349302123883686de7))
* monaco perf and file tree ui ([25d7dfe](https://github.com/cloudflare/vibesdk/commit/25d7dfe70cb09615acb60c01a6aa9a69c2fc30c9))
...
* mutations are scoped to appIds ([8e91f38](https://github.com/cloudflare/vibesdk/commit/8e91f38011522f58323c14d880f68c227db41462))
* new build button colors ([ecfdac6](https://github.com/cloudflare/vibesdk/commit/ecfdac6d9b0a5efaf31dfdb4fb22bc9f5a36d5ed))
* OAuth and login fixes ([434c5b3](https://github.com/cloudflare/vibesdk/commit/434c5b3e110409f7b561c529e38db0a2bdc3ebf4))
...
* page load improvements ([3ae3d92](https://github.com/cloudflare/vibesdk/commit/3ae3d92658144ebce08637b2d52ae95df0f5bb01))
...
* preview update fixes + navigation ([5b96591](https://github.com/cloudflare/vibesdk/commit/5b96591e074f4fcc7fe15ad14236abf107fd8910))
...
* **publish:** install pnpm via action-setup for pack ([e853fe0](https://github.com/cloudflare/vibesdk/commit/e853fe0c72746c09b0e45b3d24e6713ee354de4a))
* **publish:** pack with pnpm so catalog ranges resolve ([4cc22c2](https://github.com/cloudflare/vibesdk/commit/4cc22c25f27e5b2a5fcacc90efe452fef3dad57c))
...
* redesign profile page and fix routes and link it ([a00703a](https://github.com/cloudflare/vibesdk/commit/a00703a3aa1b771c2b2a0a320fa2b99e2d0dee97))
* reduce chat max-width when main view is visible ([ac890c1](https://github.com/cloudflare/vibesdk/commit/ac890c1a3f68c85629e9c53fa9cd4363bb92470b))
...
* reload chat session when switching apps in the sidebar ([076f3d1](https://github.com/cloudflare/vibesdk/commit/076f3d1cbdf44ee59ed385b931a0645853fac2c8))
* remove and ignore tsbuildinfo file ([2cf7ff5](https://github.com/cloudflare/vibesdk/commit/2cf7ff552902bb50b0d32c836eb0fd82b1e90d82))
* remove app creation initialization bottleneck ([1ac531f](https://github.com/cloudflare/vibesdk/commit/1ac531fe7ecb1c4f4bd70691a58f6deb76418df9))
* remove explicit header background ([71cacf9](https://github.com/cloudflare/vibesdk/commit/71cacf9b61ce1301ff52c15a6258ebd21c2b4233))
...
* remove unused google fonts ([96dd6cc](https://github.com/cloudflare/vibesdk/commit/96dd6ccb51ab28f522ac1e3ba1d0346b399dba40))
* remove vault provider and its code in frontend ([981286f](https://github.com/cloudflare/vibesdk/commit/981286ff4bc9e39c8e28b08f80067e53178d36ef))
...
* search and deploy for preview screen ([30ce835](https://github.com/cloudflare/vibesdk/commit/30ce835ac7f4b9389840543a689517b443778452))
* secure immediate Cloudflare connection ([69cb053](https://github.com/cloudflare/vibesdk/commit/69cb053ca89b30976531c3a49addad1bd83b118a))
...
* **security:** key anonymous rate limit on IP, remove dead email-OTP … ([b20cf32](https://github.com/cloudflare/vibesdk/commit/b20cf32ab351f34c9ef2a6768223d82041f635d9))
* **security:** key anonymous rate limit on IP, remove dead email-OTP flow ([0548ff3](https://github.com/cloudflare/vibesdk/commit/0548ff30d11ed43e5b59001f144ecd056da50e89))
* **security:** strip browser credentials at sandbox proxy and redact git logs ([b3db5dc](https://github.com/cloudflare/vibesdk/commit/b3db5dcfa794313042f5967fce4e15892bf8d0ad))
...
* set a max-width on app and chat page titles ([efbd8d7](https://github.com/cloudflare/vibesdk/commit/efbd8d728363c26301db46aa12685980daf22fd3))
* set mobile breakpoint to 0 temporarily ([d589a95](https://github.com/cloudflare/vibesdk/commit/d589a95ea8db5a60bff5335c72c4a2a346e14ed6))
* settings page bg not filling full height ([be7dc8a](https://github.com/cloudflare/vibesdk/commit/be7dc8a382c7d3a6593a243e0734079b59ce336f))
* settings ui use kumo ([5964a64](https://github.com/cloudflare/vibesdk/commit/5964a645a0a1d267a64cb40d6765162e30712fae))
* show 24 recent public apps on homepage ([80ee28c](https://github.com/cloudflare/vibesdk/commit/80ee28cdbb0eda50024ceb1575d47e49b721adc2))
* show password validation error ([4c86278](https://github.com/cloudflare/vibesdk/commit/4c862784f5bba62716cc6ec6926e14ec742c6a23))
* show running tool call at end separately ([f5251d3](https://github.com/cloudflare/vibesdk/commit/f5251d3ced9f8ec6d46166845f1940496e76fc43))
* sidebar and app, chat route ui fixes ([72810a5](https://github.com/cloudflare/vibesdk/commit/72810a5c7593eafb8efd011af30f4cd8c6f4db57))
* sidebar component usage and improvements ([e33519c](https://github.com/cloudflare/vibesdk/commit/e33519c7e5aa548e476c0478a6104a011e19cf31))
* sidebar menu icons collapsed ui ([9de97df](https://github.com/cloudflare/vibesdk/commit/9de97dfa7f39966dbdf9ea4db977966b181dd8e2))
* **sidebar:** sidebar, app header and chat route ui fixes ([aee3d18](https://github.com/cloudflare/vibesdk/commit/aee3d18703eed1e77057cdf0a764bf66785e6aab))
* **space:** checkpoint flush reads overlay, replay checkpoint in state fast-path ([15ebbec](https://github.com/cloudflare/vibesdk/commit/15ebbec16f255173500665d4da584721bc93162c))
* **space:** durable workspace files and git history across DO resets ([ff8f53c](https://github.com/cloudflare/vibesdk/commit/ff8f53ce4d1d0f29c045a96260221c540f63b6af))
* **space:** stabilize artifacts sync and preview deploys ([f7e3123](https://github.com/cloudflare/vibesdk/commit/f7e31238a06f3f9e21a30980809c50a617afeaba))
...
* streamline deploy button configuration ([61bc5f7](https://github.com/cloudflare/vibesdk/commit/61bc5f78d1eaa87f917e76d8c9cf3bb6b5f4f3b1))
...
* template cache clear before import + init meta in behavior constructor ([c6a329e](https://github.com/cloudflare/vibesdk/commit/c6a329e13b34e02da3ff3631b40738154a5de2da))
* template import and state init ([9f5f787](https://github.com/cloudflare/vibesdk/commit/9f5f787a8c1a40e04e02c220ab3c900eb44b3ca6))
* template initialization ([7db6ca2](https://github.com/cloudflare/vibesdk/commit/7db6ca2a7d8f9f6e418e38379a5e25f0caaf5c0d))
* **think:** align deploy action styling ([c37a2b1](https://github.com/cloudflare/vibesdk/commit/c37a2b17f92fce38e0c7c250768e855a09a33d14))
* **think:** charge credits for model steps ([e5839d0](https://github.com/cloudflare/vibesdk/commit/e5839d0e362bc1ba33211bf50ba8747c0628a9fb))
* **think:** end max-steps wrap-up on a user turn ([64d6a93](https://github.com/cloudflare/vibesdk/commit/64d6a930ee45a7b24a5ce90c6442bcafff8f06e6))
...
* ui and convo state management ([0323c7a](https://github.com/cloudflare/vibesdk/commit/0323c7a04e20a6abae41ee1ca7483b6360e4698f))
...
* ui auto focus, preview hiding and blueprints ([cfe24e3](https://github.com/cloudflare/vibesdk/commit/cfe24e3e99b418bca97cd4d5bd8d30602a6a7ebe))
* ui issues ([3774ee0](https://github.com/cloudflare/vibesdk/commit/3774ee0220eacbc0f94b687da72425a2964c9810))
...
* update favicon ([42bd828](https://github.com/cloudflare/vibesdk/commit/42bd8283ad0157238111b3974051de957b5de5da))
* update private clone button design ([5d0d908](https://github.com/cloudflare/vibesdk/commit/5d0d90811d83572c11cba0e04a34f0dd098fddf4))
* upgrade framer-motion and monaco-editor to latest ([ca61644](https://github.com/cloudflare/vibesdk/commit/ca616445146851f0b8b80929657e214e41128f6c))
* upgrade kumo ([9f40750](https://github.com/cloudflare/vibesdk/commit/9f40750e7e8556d579ccd2a6630ec74c4157a0dd))
* upgrade vite to v8 which uses rolldown-vite ([c8fb2dd](https://github.com/cloudflare/vibesdk/commit/c8fb2dde92f25988c51a3d0bde65c553c76eff1a))
* use current AI Gateway credit balance endpoint ([7d28ac6](https://github.com/cloudflare/vibesdk/commit/7d28ac69bde550439170fc6212f6dfb77536bdb7))
* use funky-mono font for settings headers ([d5fb118](https://github.com/cloudflare/vibesdk/commit/d5fb11880e0509ad96aac3ea553a9a5fbe6a5d6d))
* use global-header with sidebar-toggle and sign in button ([24eedaa](https://github.com/cloudflare/vibesdk/commit/24eedaab98189b8b5415a2b539de27d821300c37))
* use kumo tabs for visibility filter in apps page ([e9d8c4e](https://github.com/cloudflare/vibesdk/commit/e9d8c4e5524d7f0f69684eaf74d5eb2c3c19f2c9))
* use kumo-subtle instead of text-tertiary ([9d61861](https://github.com/cloudflare/vibesdk/commit/9d61861527833ad3349f5ec6244321911150ab7e))
* use per page titles as per context ([d8e50e7](https://github.com/cloudflare/vibesdk/commit/d8e50e7ca0ad4eeb25dd123162f100b0d2735625))
...
* use sidebar persisted state as default ([ac280a6](https://github.com/cloudflare/vibesdk/commit/ac280a608df3c098c28d7bedec0052a74c5bcfa8))
* use tanstack query for all fetch calls ([3c1bb93](https://github.com/cloudflare/vibesdk/commit/3c1bb935676aa316c7e5b4bfb3c8adfc99877f6f))
* use tanstack query for discover page and homepage ([121b8a7](https://github.com/cloudflare/vibesdk/commit/121b8a7010eb93588b5af85fd585feb1551d28bd))
* use tanstack query for usage limits api calls ([3d737ac](https://github.com/cloudflare/vibesdk/commit/3d737ac5ac48b6e7cf6e1a9a5bdf7dd3bc02b08b))
...
* wire up onConnect to coding agent ([318f6e2](https://github.com/cloudflare/vibesdk/commit/318f6e2620654e3c442c5926c84a296bd940d619))
* wrangle rupdate ([9666d98](https://github.com/cloudflare/vibesdk/commit/9666d98518b2292b0aa58e1aee18ac1a95cbb2e9))


### Performance Improvements

* lazy load monaco editor ([61afce2](https://github.com/cloudflare/vibesdk/commit/61afce27afe9a744f26e70dc0575cdd6f659687d))
* prune unchanged subtrees when computing commit diffs ([bd5572c](https://github.com/cloudflare/vibesdk/commit/bd5572c5358a0005ef38da8d86496213e290319a))
